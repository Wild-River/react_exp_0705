...
const products = [
  { id: 1, name: 'Tシャツ', price: 2980, stock: 4, category: 'アパレル' },
      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          {products.map((product) => (
            <ProductCard key={product.id} name={product.name} price={product.price} stock={product.stock} category={product.category} />
          ))}
        </div>
      </main>
    </div>
